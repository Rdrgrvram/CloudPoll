 ...
 * DynamoDB Local corre en localhost:8000 vía docker-compose.
 *
 * Uso:
...
// ── Rutas ────────────────────────────────────────────────────────────────────
// POST /polls — crear encuesta (en local no valida JWT)
...
// POST /suggest — sugerencias IA (requiere cuenta Bedrock)
